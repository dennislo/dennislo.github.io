  ...
  <article className="cv">
    ...
    <section className="intro">
      <p>
        ...
        robust, scalable solutions that solve real problems. I have deep
        expertise across the full stack, I thrive in fast-paced, collaborative
    ...
    <section className="intro">
      ...
      <p>
        ...
        technical challenges, from system architecture and full-stack
